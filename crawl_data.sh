...
# Run Raul's KOSearch program in terminal
java -cp kgml.jar KOSearch.KOSearch -i ../pathway/Bacteria_511145.12.PATRIC/csv/Seq_KO.csv -o Bacteria_511145.12.PATRIC/
java -cp kgml.jar KOSearch.KOSearch -i ../pathway/Bacteria_1385755.3.PATRIC/csv/Seq_KO.csv -o Bacteria_1385755.3.PATRIC/
java -cp kgml.jar KOSearch.KOSearch -i ../pathway/Bacteria_1385755.5.PATRIC/csv/Seq_KO.csv -o Bacteria_1385755.5.PATRIC/
java -cp kgml.jar KOSearch.KOSearch -i ../pathway/Bacteria_1385755.6.PATRIC/csv/Seq_KO.csv -o Bacteria_1385755.6.PATRIC/
