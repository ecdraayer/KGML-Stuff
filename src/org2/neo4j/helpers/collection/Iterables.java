 ...
 */
package org2.neo4j.helpers.collection;

import static org2.neo4j.helpers.collection.Iterators.asResourceIterator;
...
public final class Iterables
{
     ...
     * @param <T> the type of items in the iterator.
     * @param iterable the {@link Iterable} to count items in.
     * @param predicate the filter to test items against
     * @return the number of found in {@code iterable}.
     */
    public static <T> long count( Iterable<T> iterable, org.neo4j.function.Predicate<Object> predicate )
    {
