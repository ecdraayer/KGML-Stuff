...
import org2.neo4j.helpers.collection.MapIterable.MapIterator;
...
public abstract class Iterators
{
     ...
     */
    public static <T> long count( Iterator<T> iterator, org.neo4j.function.Predicate<Object> predicate )
    {
        long result = 0;
        while ( iterator.hasNext() )
        {
